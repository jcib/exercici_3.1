...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), true);
        $a->setEventDispatcher(($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()));
