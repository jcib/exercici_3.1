...
class __TwigTemplate_6b732e60132ac13dfb18386def2a6d48edeaa050c535d65eb1fffaec6c8a2c8d extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"example-wrapper\">
    <h1>LLISTA DE ROLES</h1>

    <h3>EL TEU ROLE MÀXIM ÉS: ";
        // line 14
        echo twig_escape_filter($this->env, (isset($context["role_maximo"]) || array_key_exists("role_maximo", $context) ? $context["role_maximo"] : (function () { throw new RuntimeError('Variable "role_maximo" does not exist.', 14, $this->source); })()), "html", null, true);
        echo "</h3>
    <h3>INFORMACIÓ D'USERS:</h3>
    ";
        // line 16
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["array_users"]) || array_key_exists("array_users", $context) ? $context["array_users"] : (function () { throw new RuntimeError('Variable "array_users" does not exist.', 16, $this->source); })()));
...
";
    ...
    {
        return array (  116 => 19,  107 => 17,  103 => 16,  98 => 14,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"example-wrapper\">
    ...
    <h3>EL TEU ROLE MÀXIM ÉS: {{ role_maximo }}</h3>
    <h3>INFORMACIÓ D'USERS:</h3>
    {% for key,user in array_users %}
        <li>{{ user.email }}</li>
    {% endfor %}
</div>
{% endblock %}
", "role/index.html.twig", "/var/www/html/demo/templates/role/index.html.twig");
    }
}
